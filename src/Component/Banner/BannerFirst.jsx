...
const BannerFirst = () => {
    return (
       <div className="py-10 bg-blue-950 text-white lg:flex items-center justify-around">
        <div>
            <h1 className="p-2 rounded-lg text-black font-bold bg-slate-50 w-80">Professional career counseling services</h1>
